      ...
      <div className="hidden lg:flex items-center justify-between min-h-screen px-8 xl:px-16 relative z-10">
        ...
        >
          ...
          <p className="text-white/80 text-base leading-relaxed text-right">
            دليلك هو مرشد أكاديمي ذكي يعتمد على تقنيات الذكاء الاصطناعي لمساعدة طلبة كلية علوم الحاسب هندسة الحاسب في جامعة جدة.
            يمكن لدليلك الإجابة عن الأسئلة المتعلقة بالمقررات والأسئلة المتعلقة بالخطة الدراسية،
            التدريب الصيفي والتعاوني، الشهادات الإحترافية والأنشطة الطلابية.
          </p>
        </motion.div>
