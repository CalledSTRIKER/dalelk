...
const SURVEY_NOTE = "> نقوم حاليًا بإستبيان يقيس جودة مخرجات المشروع وسبل تطويره، وعليه فإننا نطلب منك تكرمًا أن تشارك فيه على الرابط التالي:\n> [اضغط هنا للمشاركة في الاستبيان](https://forms.gle/MEwNt8uh76wNrRMq8)";
            ...
            <>
              ...
              {message.question_id && (
                <ReactMarkdown
                  components={{
                    blockquote: ({ children }) => (
                      <blockquote className="border-r-4 border-accent/50 pr-3 my-2 text-sm opacity-70">{children}</blockquote>
                    ),
                    a: ({ href, children }) => (
