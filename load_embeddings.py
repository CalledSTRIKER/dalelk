...
try:
    ...
    courses_index = faiss.read_index(f"{REPO_DIR}/indicies/courses_index.index")
except Exception as e:
...
try:
    ...
    certs_index = faiss.read_index(f"{REPO_DIR}/indicies/certs_index.index")
except Exception as e:
...
try:
    ...
    qa_idmap = faiss.read_index(f"{REPO_DIR}/indicies/qa_idmap.index")
    qa_index = faiss.read_index(f"{REPO_DIR}/indicies/qa_index.index")
except Exception as e:
