...
try:
    ...
    faiss.write_index(courses_index, "/root/final_project/indicies/courses_index.index")
except Exception as e:
...
try:
    ...
    faiss.write_index(certs_index, "/root/final_project/indicies/certs_index.index")
except Exception as e:
...
try:
    ...
    faiss.write_index(qa_index, "/root/final_project/indicies/qa_index.index")
    faiss.write_index(qa_idmap, "/root/final_project/indicies/qa_idmap.index")
except Exception as e:
